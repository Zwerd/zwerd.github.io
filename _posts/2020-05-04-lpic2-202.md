...
So the new mail was found under new folder, if you try to use `mail` command for see new mail it will not work for you because the mails are save in the new folder.
