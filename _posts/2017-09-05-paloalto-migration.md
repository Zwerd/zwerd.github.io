...
excerpt: "Hi guys, so you may ask yourself why I wrote this article, so the answer is that I search all over the NET and
didn’t find seriously documentation about the migration from Check Point to Palo Alto Network.
So I’m here today to make this basic article and to help you"
tags:
- PaloAlto
---
...
[Click Here for PDF version](http://zwerd.com/docs/PaloAlto%20-%20Basic%20Migration%20from%20Check%20Point%20to%20Palo%20Alto%20Network.pdf)
