...
**note:** Because I just copy past that all screen I had a lot of issue on the second screen. The navigator doesn't work well, some function doesn't work as I wanted and other worked fine, but the main issue was the dame style view that doesn't get the shape that I want to make on that screen. So please be careful if you going to build app by copy stuff and past it all over the time. The time you spend on it later is not worth it!!!
